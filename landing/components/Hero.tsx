...
const Hero: React.FC<HeroProps> = ({ onStartDemo, onStartRegistration }) => {
  return (
    <section className="relative pt-12 md:pt-24 pb-16 md:pb-32 px-4 md:px-6 text-center overflow-hidden max-w-7xl mx-auto">
      <div className="max-w-5xl mx-auto space-y-8 md:space-y-12">
        ...
        <p className="text-lg md:text-2xl text-slate-500 max-w-3xl mx-auto leading-relaxed font-medium px-4">
          Odkryj najbardziej intuicyjną platformę CRM & WMS dla sektora B2B. <br className="hidden md:block" /> Zaprojektowana, by skalować Twój biznes z lekkością systemu iOS.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-6 md:pt-10">
          <button
            onClick={onStartRegistration}
            className="w-full sm:w-auto px-10 py-4 md:px-12 md:py-5 bg-blue-600 text-white rounded-full font-bold text-lg hover:bg-blue-700 transition-all shadow-2xl active:scale-95 hover:shadow-blue-500/20"
          >
            Rozpocznij za darmo
          </button>
          <button
